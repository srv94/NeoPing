...
<script class="include" type="text/javascript"
	src="<c:url value="/assets/js/jquery.dcjqaccordion.2.7.js" />"></script>
<script src="<c:url value="/assets/js/jquery.scrollTo.min.js" />"></script>
<script src="<c:url value="/assets/js/jquery.nicescroll.js" />"
...
<script type="text/javascript"
	src="<c:url value="/assets/js/gritter/js/jquery.gritter.js" />"></script>
<script type="text/javascript"
	src="<c:url value="/assets/js/gritter-conf.js" />"></script>
