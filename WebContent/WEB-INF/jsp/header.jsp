			...
			<li id="header_inbox_bar" class="dropdown"><a
				...
				<ul class="dropdown-menu extended inbox">
					...
					<li><a href="index.html#"> <span class="photo"><img
								alt="avatar" src="<c:url value="/assets/img/ui-zac.jpg" />"></span>
					...
					<li><a href="index.html#"> <span class="photo"><img
								alt="avatar" src="<c:url value="/assets/img/ui-divya.jpg" />"></span>
					...
					<li><a href="index.html#"> <span class="photo"><img
								alt="avatar" src="<c:url value="/assets/img/ui-danro.jpg" />"></span>
					...
					<li><a href="index.html#"> <span class="photo"><img
								alt="avatar" src="<c:url value="/assets/img/ui-sherman.jpg" />"></span>
